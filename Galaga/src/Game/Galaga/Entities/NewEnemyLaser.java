 ...
 */
public class NewEnemyLaser extends BaseEntity {

    EntityManager enemies;
    int speed = 9;

    public NewEnemyLaser(int x, int y, int width, int height, BufferedImage sprite, Handler handler,EntityManager enemies) {
