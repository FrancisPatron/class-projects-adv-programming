...
public class GameState extends State {
    ...
    public void refresh() {
        ...
        uiManager.addObjects(new UIImageButton(((handler.getWidth() / 2)) - ((handler.getWidth() / 14)) , (handler.getHeight() /2)-(handler.getHeight() /32)-15, handler.getWidth()/8+45, handler.getHeight()/8+45, Images.pacmanLogo, new ClickListlener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUimanager(null);
