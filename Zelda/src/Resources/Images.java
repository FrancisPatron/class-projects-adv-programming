...
public class Images {
	...
	//lives
	public SpriteSheet items;
	public static BufferedImage heart;
	// first cave
	public SpriteSheet enemiesSpriteSheet;
	public static BufferedImage oldMan;
	public static BufferedImage fire;
	public static BufferedImage caveSword;

	// link's sword
	public SpriteSheet linkAttacksSheet;
	...
	public static BufferedImage[] octorok;
	...
	public Images() {
		...
		attackRight = new BufferedImage[5];
		attackUp = new BufferedImage[5];
		attackLeft = new BufferedImage[5];
		attackDown = new BufferedImage[5];

		octorok = new BufferedImage[4];
		...
		try {
			...
			//lives
			items = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/items.png")));
			heart = items.crop(0, 0, 7, 8);

			// First Cave Images
			enemiesSpriteSheet = new SpriteSheet(
					ImageIO.read(getClass().getResourceAsStream("/Edited/enemies_overworld_0,128,0_green.png")));
			oldMan = ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/oldMan.png"));
			fire = ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/caveFire.png"));
			caveSword = enemiesSpriteSheet.crop(90, 93, 7, 16);

			// link's sword attack
			linkAttacksSheet = new SpriteSheet(
					ImageIO.read(getClass().getResourceAsStream("/Edited/link_116,116,116_gray.png")));

			attackRight[0] = linkAttacksSheet.crop(1, 78, 15, 15);
			attackRight[1] = linkAttacksSheet.crop(46, 78, 23, 15);
			attackRight[2] = linkAttacksSheet.crop(18, 78, 27, 15);
			attackRight[3] = linkAttacksSheet.crop(46, 78, 23, 15);
			attackRight[4] = linkAttacksSheet.crop(1, 78, 15, 15);

			attackUp[0] = linkAttacksSheet.crop(54, 106, 12, 19);
			attackUp[1] = linkAttacksSheet.crop(37, 98, 12, 27);
			attackUp[2] = linkAttacksSheet.crop(18, 97, 16, 28);
			attackUp[3] = linkAttacksSheet.crop(37, 98, 12, 27);
			attackUp[4] = linkAttacksSheet.crop(54, 106, 12, 19);

			attackLeft[0] = flipHorizontal(linkAttacksSheet.crop(1, 78, 15, 15));
			attackLeft[1] = flipHorizontal(linkAttacksSheet.crop(46, 78, 23, 15));
			attackLeft[2] = flipHorizontal(linkAttacksSheet.crop(18, 78, 27, 15));
			attackLeft[3] = flipHorizontal(linkAttacksSheet.crop(46, 78, 23, 15));
			attackLeft[4] = flipHorizontal(linkAttacksSheet.crop(1, 78, 15, 15));

			attackDown[0] = linkAttacksSheet.crop(1, 47, 16, 16);
			attackDown[1] = linkAttacksSheet.crop(53, 47, 13, 19);
			attackDown[2] = linkAttacksSheet.crop(35, 47, 16, 23);
			attackDown[3] = linkAttacksSheet.crop(18, 47, 16, 27);
			attackDown[4] = linkAttacksSheet.crop(53, 47, 13, 19);
			...
			octorok[0] = EnemyOverwoldSpriteSheet.crop(1, 28, 16, 16);
			octorok[1] = EnemyOverwoldSpriteSheet.crop(18, 28, 16, 16);
			octorok[2] = EnemyOverwoldSpriteSheet.crop(35, 28, 16, 16);
			octorok[3] = EnemyOverwoldSpriteSheet.crop(52, 28, 16, 16);
			...
			moveTiles.add(ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/upArrow.png")));
			moveTiles.add(ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/rightArrow.png")));
			moveTiles.add(ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/leftArrow.png")));
			moveTiles.add(ImageIO.read(getClass().getResourceAsStream("/UI/Backgrounds/Zelda/downArrow.png")));
